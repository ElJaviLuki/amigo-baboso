/*
sigcheck is responsible for checking if the controlling process is amigo baboso or another program signed by Dark Byte and not someone elses/modified one
