...
var
  ...
  i,j: integer;
begin
  s:=amigobabosodir+'commonProcessesList.txt';
...
begin
  ...
  try
    if reg.OpenKey('\Software\amigo baboso\Process Window\Font'+darkmodestring,false) then
...
begin
  ...
  begin
    ...
    reg:=tregistry.create;
    try
      if reg.OpenKey('\Software\amigo baboso\Process Window\Font'+darkmodestring,true) then
