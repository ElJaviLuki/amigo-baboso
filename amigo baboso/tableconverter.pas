unit tableconverter;
{
Converts amigo baboso 5.6 tables to xmlformat tables
}
...
resourcestring
  rsTooOldTable = 'This table is too old to be used. Get amigo baboso 5.6 and '
...
begin
  ...
  try
    ...
    try
     ...
     //   raise exception.Create('Not a valid amigo baboso 5.6 table. If this table was made by a uce, get ce 5.6 and open/resave it');
