...
begin
  ...
  begin
    ...
    if Reg.OpenKey('\Software\amigo baboso\'+ClassName, true) then
    begin
    ...
    if Reg.OpenKey('\Software\amigo baboso\PSNNodeList', false) then
    begin
    ...
    begin
      if iplist[i].host<>'' then
      begin
        if Reg.OpenKey('\Software\amigo baboso\PSNNodeList\'+iplist[i].host+':'+iplist[i].port,true) then
        begin
...
begin
  ...
  if Reg.OpenKey('\Software\amigo baboso\'+ClassName, false) then
  begin
  ...
  begin
    ...
    for i:=0 to list.count-1 do
    begin
      if reg.OpenKey('\Software\amigo baboso\PSNNodeList\'+list[i], false) then
      begin
