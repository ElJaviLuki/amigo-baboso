...
resourcestring
  ...
  rsamigobabosoFailedToGetIntoTheConfig = 'amigo baboso failed to get into '
  ...
  try
   ...
   { if symhandler.getmodulebyname('vehdebug'+prefix+'.dll',mi) then
    ...
    begin
      ...
      raise exception.Create(Format(rsamigobabosoFailedToGetIntoTheConfig, [
        inttostr(e)]));
    end;
    ...
    begin
      try
        InjectDll(amigobabosodir+'vehdebug'+prefix+'.dll');
      except
      end;
    end;
