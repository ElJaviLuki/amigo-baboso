...
begin
  ...
  begin
    ...
    begin
      ...
      fLuaSyntaxHighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\amigo baboso\Lua Highlighter'+darkmodestring);
    end;
...
begin
  ...
  if fLuaSyntaxHighlighter<>nil then
    fLuaSyntaxHighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\amigo baboso\Lua Highlighter'+darkmodestring);  //perhaps make this a var
