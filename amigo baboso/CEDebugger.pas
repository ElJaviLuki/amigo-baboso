...
resourcestring
  ...
  rsThisWillAttachTheDebuggerOfamigobabosoToTheCurrent = 'This will attach the debugger of amigo baboso to the current process.';
  rsDoNotCloseCE = 'If you close amigo baboso while the game is running, the game will close too. Are you sure you want to do this?';
  rsContinue = 'Continue?';
...
begin
  ...
  begin
    ...
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:=rsThisWillAttachTheDebuggerOfamigobabosoToTheCurrent+' '+rsDoNotCloseCE
    else
    {$endif}
      mes:=rsThisWillAttachTheDebuggerOfamigobabosoToTheCurrent+' '+rsContinue;
