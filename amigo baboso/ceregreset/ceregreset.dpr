...
begin
  ...
  try
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            reg.closekey;
            reg.OpenKey('\Software\amigo baboso', false);
          end;
    ...
    if needsToSaveStuff=false then
      reg.DeleteKey('\Software\amigo baboso'); //get rid of the whole key

    if not silent then
      messagebox(0,'Successfully reset the settings of amigo baboso','Registry Reset',0);
