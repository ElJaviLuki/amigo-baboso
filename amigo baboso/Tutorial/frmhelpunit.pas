...
begin
  {$ifdef windows}
  ShellExecute(0, PChar('open'), PChar('https://amigobaboso.org/tutorial.php?tutorial='+ftutorialtag),PChar(''), PChar(''), SW_SHOW);
  {$else}
  OpenURL('https://amigobaboso.org/tutorial.php?tutorial='+ftutorialtag);
  {$endif}
end;
