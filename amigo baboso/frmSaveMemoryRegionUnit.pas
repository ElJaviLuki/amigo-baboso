...
resourcestring
  ...
  rsNoStartAddress = 'If you don''t include the header data you''ll have to specify the startaddress yourself when loading the file(That means amigo baboso wont fill in the '
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        f.WriteBuffer(pchar('amigobaboso')^,11);
        temp:=3; //version
