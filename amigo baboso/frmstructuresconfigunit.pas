...
begin
  ...
  try
    ...
    if Reg.OpenKey('\Software\amigo baboso\DissectData',true) then
    begin
      ...
      if customfont then
      begin
        if Reg.OpenKey('\Software\amigo baboso\DissectData\Font'+darkmodestring,true) then
...
begin
  ...
  try
    ...
    begin
      ...
      if Reg.OpenKey('\Software\amigo baboso\DissectData\Font'+darkmodestring,false) then
      begin
