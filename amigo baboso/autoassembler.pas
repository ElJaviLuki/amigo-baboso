...
{$ifndef jni}
  if pluginhandler=nil then exit; //Error. amigo baboso is not properly configured
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                s2:=amigobabosodir+'includes'+pathdelim+'s1';
                if fileexists(s2) then s1:=s2 else
                begin
                  s2:=amigobabosodir+s1;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                begin
                {$endif}
                  if fileexists(amigobabosodir+s2) then s1:=amigobabosodir+s2 else
                    if fileexists(getcurrentdir+ PathDelim+s2) then s1:=getcurrentdir+PathDelim+s2 else
                      if fileexists(amigobabosodir+s1) then s1:=amigobabosodir+s1;
                {$ifdef windows}
                end;
                {$endif}
