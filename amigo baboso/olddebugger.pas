...
begin
  ...
  begin
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:='This will attach the debugger of amigo baboso to the current process. If you close amigo baboso while the game is running, the game will close too. Are you sure you want to do this?'
    else
      mes:='This will attach the debugger of amigo baboso to the current process. Continue?';
...
//        attaching:=false;
        ...
        err:='amigo baboso failed to create the process. (Error='+pchar(IntToStr(GetLastError))+')';
        messagebox(0,pchar(err),'Create failure',mb_ok);
  ...
  //    }
      ...
      begin
        ...
        {$ifndef net}
        err:='amigo baboso failed to attach to the process. (Error='+IntToStr(GetLastError)+')';
        ...
        case devent.dwDebugEventCode of
          ...
          begin
            ...
            begin
              ...
              begin
                //check if this is a exception breakpoint that was made by amigo baboso
                      ...
                      try
                        ...
                        begin
                          ...
                          begin
                            ...
                            j:=devent.dwThreadId;
                            if not WaitForDebugEvent(devent,10000) then application.MessageBox('userbreakpoint bug','amigo baboso Debugger',0);
