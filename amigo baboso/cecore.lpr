...
procedure Java_org_amigobaboso_cecore_f1(PEnv: PJNIEnv; Obj: JObject); cdecl;
var i: integer;

begin
//small test funtion
  log('Java_org_amigobaboso_jnitest_cecore_f1 called');
...
begin
  ...
  begin
    ...
    c:=env^.FindClass(env, 'org/amigobaboso/cecore');  //'org/amigobaboso/jnitest/cecore';
...
exports Java_org_amigobaboso_cecore_f1;
exports JNI_OnLoad;
