// Copyright amigo baboso. All Rights Reserved.
...
resourcestring
  ...
  rsMSTheScanWasForcedToTerminateSubsequentScansMayNotFunctionProperlyEtc = 'The scan was forced to terminate. Subsequent scans may not function properly. It''s recommended to restart amigo baboso';
  rsThread = 'thread ';
//===============Local functions================//
...
begin
  ...
  fScanResultFolder:=usedtempdir+'amigo baboso'+pathdelim;
 ...
 // OutputDebugString('TMemscan.DeleteScanfolder');
  ...
  begin
    try
      ...
      if FindFirst(usedtempdir+'amigo baboso'+pathdelim+'{*}',  faDirectory , info)=0 then
      begin
        repeat
          ...
          begin
            ...
            begin
              ...
              f:=usedtempdir+'amigo baboso'+pathdelim+info.name;
