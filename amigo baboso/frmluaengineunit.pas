...
begin
  synhighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\amigo baboso\Lua Highlighter'+darkmodestring);
end;
...
begin
  ...
  begin
    synhighlighter.SaveToRegistry(HKEY_CURRENT_USER, '\Software\amigo baboso\Lua Highlighter'+darkmodestring);
