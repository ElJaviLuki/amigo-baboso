			...
			if (i)
			{
			 ...
			 // STATUS=0x80070002;
			  if (!FAILED(STATUS))
			  {
				  ...
				  if (!correctversion)
				  {
					  MessageBoxA(0,"Please update your amigo baboso version to amigo baboso 6.3 or later\n", "Launch Error",MB_OK | MB_ICONERROR);
				  }
				  else
				  {
					  //launch it
					  ...
					  {						  
						  //Because amigo baboso deletes files with name CET_TRAINER.CETRAINER it can be used to determine when ce is finished with it			  
			  ...
			  else
			  {
				  ...
				  else
				  {
					  ...
					  sprintf_s(errorstring, 254,"Your system must have amigo baboso installed to be able to use this trainer\nwww.amigobaboso.org\n(%x)", STATUS);
