...
begin
  shellexecute(0,'open',pchar('https://www.patreon.com/amigobaboso'),nil,nil,sw_maximize);
end;

procedure TAbout.Label8Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('https://amigobaboso.org/'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;

procedure TAbout.Label9Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('http://forum.amigobaboso.org/'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;
