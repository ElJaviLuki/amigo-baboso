  ...
  begin
    ...
    try
      ...
      if version<>{$ifdef cpu64}1{$else}0{$endif} then
        raise exception.create('This trace was made with the '+{$ifdef cpu64}'32'{$else}'64'{$endif}+'-bit version of amigo baboso. You need to use that version to see the register values and stacktrace');
