...
resourcestring
  ...
  rsUUPleaseRunThe64bitVersionOfamigobabosoToMakeUseOfThisFeature = 'Please run the 64-bit version of amigo baboso to make use of this feature';
...
begin
  ...
  {$ifdef cpu32}
  if Is64bitOS then raise exception.create(rsUUPleaseRunThe64bitVersionOfamigobabosoToMakeUseOfThisFeature);
  {$endif}
