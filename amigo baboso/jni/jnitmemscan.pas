...
begin
  ...
  c:=penv^.FindClass(penv, 'org/amigobaboso/TObject');
...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  (name: 'create'; signature: '(Lorg/amigobaboso/TMemScan;)J'; fnPtr: @TMemScan_Create),
...
begin
  ...
  c:=env^.FindClass(env, 'org/amigobaboso/TMemScan');
