...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  ...
  (name: 'GetEntry'; signature: '(I)Lorg/amigobaboso/AddressListEntry;'; fnPtr: @addresslist_getEntry),
  (name: 'SetEntry'; signature: '(ILorg/amigobaboso/AddressListEntry;)V'; fnPtr: @addresslist_setEntry),
  (name: 'AddEntry'; signature: '(Lorg/amigobaboso/AddressListEntry;)I'; fnPtr: @addresslist_addEntry),
...
begin
  ...
  c:=env^.FindClass(env, 'org/amigobaboso/AddressList');
  env^.RegisterNatives(env, c, @jnimethods[0], methodcount);

  c:=env^.FindClass(env, 'org/amigobaboso/AddressListEntry');
