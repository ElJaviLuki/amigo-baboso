...
resourcestring
  ...
  rsYouAreMissingTheDriver = 'You are missing the driver. Try reinstalling amigo baboso, and try to disable your anti-virus before doing so.';
  ...
  rsTheDriverThatIsCurrentlyLoaded = 'The driver that is currently loaded belongs to a different version of amigo baboso. Please unload this driver or reboot.';
  ...
  rsPleaseRunThe64BitVersionOfCE = 'Please run the 64-bit version of amigo baboso';
