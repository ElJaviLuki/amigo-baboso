...
resourcestring
  ...
  rsThisIsQuiteABigStructureHowManyBytesDoYouWantToSav = 'This is quite a big '
   ...
   rsDoYouWantamigobabosoToTryAndFillInTheMostBasicType = 'Do you want Cheat '
   ...
   rsWrongVersion = 'This structure file was generated with a newer version of '
     +'amigo baboso. (That means there''s more than likely a new version so '
     +'please update....)';
...
begin
  ...
  try
    ...
    if Reg.OpenKey('\Software\amigo baboso\DissectData',false) then
    begin
...
begin
  ...
  begin
    ...
    autoFillIn:=messagedlg(rsDoYouWantamigobabosoToTryAndFillInTheMostBasicType, mtconfirmation, [mbyes, mbno, mbcancel], 0);
